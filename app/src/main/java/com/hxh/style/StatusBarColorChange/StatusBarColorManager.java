...
/**
 * Course to manage status and navigation bar tint effects when using KitKat
...
public class StatusBarColorManager
{
    ...
    /**
     * Course which describes system bar sizing and other characteristics for the current
